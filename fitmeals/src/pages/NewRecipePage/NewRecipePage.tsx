...
function NewRecipePage() {
  ...
  const onFinish = async (values: any) => {
    ...
    for (let i = 0; i < instsructImages.map.length; i++) {
      if (instsructImages[i] != undefined && instsructImages[i].image != undefined) {
          ...
          <div className="newRecipe">
            <Form onFinish={onFinish}>
              ...
              <Row>
                  ...
                  <Col>
                    <Form.Item name="time">
                      <Input style={{ maxWidth: '150px', width: '10vw' }} placeholder="Total time for Recipe"></Input>
                    </Form.Item>
                  </Col>
                  <Col>
                            ...
                            <Col>
                              <ImgCrop aspect={3 / 2} rotate>
                                <Dragger beforeUpload={file => {
                                  ...
                                  })) ? <img className='uploadImagePreviewInstructions' src={(instsructImages.find((item) => {
                                    return item.key === field.fieldKey
                                  }))?.image} /> :
                                    <div>
                                      <div className="imagePickerIcon">
